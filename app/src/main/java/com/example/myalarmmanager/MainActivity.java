...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnOnceDate = findViewById(R.id.btn_once_date);
        Button btnOnceTime = findViewById(R.id.btn_once_time);
        ...
        Button btnRepeatingTime = findViewById(R.id.btn_repeating_time);
